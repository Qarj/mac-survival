...
## Removing the Lima Docker

```sh
limactl stop docker
.
~/git/mac-survival$ limactl stop -f docker
INFO[0000] The QEMU process seems already stopped
INFO[0000] The host agent process seems already stopped
INFO[0000] Removing *.pid *.sock under "/Users/user.name/.lima/docker"
INFO[0000] Removing "/Users/user.name/.lima/docker/ga.sock"
INFO[0000] Removing "/Users/user.name/.lima/docker/ha.sock"
.
limactl delete docker
.
Warning: Treating docker as a formula. For the cask, use homebrew/cask/docker
Uninstalling /opt/homebrew/Cellar/docker/20.10.17... (12 files, 55.2MB)
.
brew uninstall lima
.
